...
# Language recognition returns text
def speech_text():
...
# Currently, cv2 is used to display images, but the variable jpeg can be used to return images
def bar_chart():
    global bar_c
...
#Enter the path to the wav file and extract the features
...
# Record audio and then predict, and finally return the probability of 7 sentiment categories
def predict_audio():
    ...
    # sort
    # anger     disgust     fear   happy    neutral surprise
    print(y_pred)
